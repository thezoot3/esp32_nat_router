...
#define WEBSOCKET_URL "ws://192.168.4.2:8080"
#define WEBSOCKET_AUTH_TOKEN "1234"
...
static void websocket_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case WEBSOCKET_EVENT_DATA:
        ...
        ESP_LOGW(TAG, "JSON={action: '%s'}", cJSON_GetObjectItem(root, 'action')->valuestring);
        if (root)
        {
...
static void websocket_service_start(void)
{
    esp_websocket_client_config_t websocket_cfg = {};
    websocket_cfg.uri = WEBSOCKET_URL;
    websocket_cfg.headers = 'Authorization: Basic ' + WEBSOCKET_AUTH_TOKEN;
